...
import { getDocumentSummary, getQuiz, chat, careerChat, agentChat, listConversations, deleteConversation, getConversation, queryProject } from "../controllers/ai.controller";
...
// AI Agent (can answer questions AND execute actions)
