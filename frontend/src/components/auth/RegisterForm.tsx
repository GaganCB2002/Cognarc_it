...
export function RegisterForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 w-full max-w-sm mx-auto">
      ...
      <div>
        <label className="block text-sm font-medium text-st-text-secondary mb-1.5">Full Name</label>
        <input
          type="text"
          value={name}
      ...
      <div>
        <label className="block text-sm font-medium text-st-text-secondary mb-1.5">Confirm Password</label>
        <input
          type="password"
      ...
      <p className="text-center text-sm text-st-text-muted">
        ...
        <Link href="/login" className="text-st-accent hover:text-st-accent-hover transition-colors font-medium">Sign in</Link>
      </p>
    </form>
  );
}
